...
let story = 
`On a ${adjective1} Halloween night in the${place1}, the crewmates were ${verb1} to complete their tasks. Suddenly, a ${adjective2} shadow appeared, and everyone gasped at the sight of the ${friend1}. The crewmates had to **run** fast to avoid being caught!

They gathered in${place2}, where they noticed ${color1} ${noun1} lurking in the darkness. The air was filled with a  ${emotion1} feeling as they tried to figure out who the imposter was.`;
